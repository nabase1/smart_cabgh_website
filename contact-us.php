...
<title>Smartcab gh | Contact Us</title>
<!--Bootstrap -->
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:+233546000888"><?php echo htmlentities($result->ContactNo); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-whatsapp" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="https://wa.me/+233577998000/?"><?php echo htmlentities($result->whatsappNo); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:smartcab@gmail.com"><?php echo htmlentities($result->EmailId); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC31qg8EaTcIjQ6BGR6lWs6ny42n1sb0DY&libraries=places&callback=initMap" async defer></script>
