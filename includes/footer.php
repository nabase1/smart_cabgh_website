        ...
        <div class="col-md-6 col-md-push-6 text-right">
          <div class="footer_widget">
            ...
            <ul>
              ...
              <li><a href="https://wa.me/+233577998000/?text=Hello%20welcome%20to%20SmartcabGh"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></li>
              <li><a href="https://instagram.com/scab_gh"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; <?php echo date("Y");?> smartcabgh. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </div>
