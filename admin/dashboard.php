...
<head>
	...
	<title>Smartcabgh | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Total Rental Bookings</div>
												</div>
											</div>
                                    ...
                                    <div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
<?php 
$sql2 ="SELECT id from tblbookingcab ";
$query2= $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$bookings=$query2->rowCount();
?>
													...
													<div class="stat-panel-number h1 "><?php echo htmlentities($bookings);?></div>
													<div class="stat-panel-title text-uppercase">Total Scab Bookings</div>
												</div>
											</div>
											<a href="manage-scab-booking.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
