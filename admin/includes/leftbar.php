...
<li><a href="#"><i class="fa fa-sitemap"></i> Vehicles</a>
                ...
                <li><a href="#"><i class="fa fa-sitemap"></i>Packages</a>
					<ul>
						<li><a href="post-package.php">Post a Package</a></li>
						<li><a href="manage-packages.php">Manage Packages</a></li>
					</ul>
				</li>
                 <li><a href="#"><i class="fa fa-sitemap"></i>S-Ads</a>
					<ul>
						<li><a href="post-sads.php">Post S-Ads</a></li>
						<li><a href="manage-sads.php">Manage S-ads</a></li>
					</ul>
				</li>
				<li><a href="manage-bookings.php"><i class="fa fa-users"></i> Manage Rental Booking</a></li>
                <li><a href="manage-scab-booking.php"><i class="fa fa-users"></i> Manage Scabs Booking</a></li>
