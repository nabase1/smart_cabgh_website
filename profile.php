...
$sql="update tblusers set FullName=:name,ContactNo=:mobileno,dob=:dob,Address=:adress,City=:city,Country=:country,image=:img where EmailId=:email";
...
move_uploaded_file($_FILES['img']['tmp_name'],"assets/images/$email/".$_FILES['img']['name']);
...
<title>Smartcabgh | My Profile</title>
<!--Bootstrap -->
